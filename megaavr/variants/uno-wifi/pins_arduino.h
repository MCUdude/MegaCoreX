...
#define PIN_WIRE_HWSERIAL0_TX           (PIN_PB4)
#define PIN_WIRE_HWSERIAL0_RX           (PIN_PB5)
...
#define PIN_WIRE_HWSERIAL1_TX           (PIN_PC4)
#define PIN_WIRE_HWSERIAL1_RX           (PIN_PC5)
...
#define PIN_WIRE_HWSERIAL2_TX           (PIN_PA4)
#define PIN_WIRE_HWSERIAL2_RX           (PIN_PA5)
#define PIN_WIRE_HWSERIAL2_TX_PINSWAP_1 (PIN_PA0)
#define PIN_WIRE_HWSERIAL2_RX_PINSWAP_1 (PIN_PA1)
